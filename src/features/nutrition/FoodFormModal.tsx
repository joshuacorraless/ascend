    ...
    >
      <form id="food-form" onSubmit={submit} className="space-y-4">
        ...
        <p className="text-xs text-ink-muted">
          Valores nutricionales por la porción indicada arriba.
        </p>
